...
/*   Updated: 2026/01/01 20:00:44 by flinguen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
static void	run(const char *str, va_list params, int *total)
{
	t_flags	flags;
	...
	else if (*str == '%')
	{
		...
		*total += putchar_count(*str);
	run(str + 1, params, total);
}
